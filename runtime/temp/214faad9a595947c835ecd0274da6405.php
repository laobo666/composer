<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:75:"/usr/local/nginx/www/blog/public/../application/index/view/about/about.html";i:1593512761;s:64:"/usr/local/nginx/www/blog/application/index/view/public/nav.html";i:1593564915;s:67:"/usr/local/nginx/www/blog/application/index/view/public/footer.html";i:1593566922;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title>老博博客</title>
    <link rel="stylesheet" type="text/css" href="/static/index/css/about/about.css" />
        ...
        <div class="item">
            ...
            <div class="right">
                <div class="top">
                    <h2>关于老博</h2>
                    <div class="line"></div>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;大家好，欢迎来到老博博客！老博，其实并不老。今年20了，是一名即将实习的学生。对PHP和WEB前端有着深厚的兴趣，一直在不断地探索钻研。这个博客是老博的第一个个人博客，将会记录老博生涯的点点滴滴，感谢来访与关注！</p>
                </div>
                <div class="bottom">
                    <h2>关于老博博客</h2>
                    <div class="line"></div>
                    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;老博博客是用TP5.0+Layui做的，简单方便，没有复杂的功能，就是一个简单的博客系统。做这个博客的原因也很简单，就是想把自己在学习中踩过的坑分享给大家，把一些PHP的经验和大家分享。</p>
                </div>
            </div>
        </div>
    </div>
